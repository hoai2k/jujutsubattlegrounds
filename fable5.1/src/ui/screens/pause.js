...
export class PauseMenu {
  ...
  show() {
    ...
    const items = [['resume', 'RESUME'], ['controls', 'CONTROLS'], ['settings', 'SETTINGS'], ['rematch', 'REMATCH'], ['select', 'CHARACTER SELECT'], ['quit', 'QUIT TO TITLE']];
  ...
  pick(k) {
    ...
    else if (k === 'quit') { this.hide(); S.go('title'); }
  }
