...
export const GOJO = {
  ...
  outfit: [
    { piece: 'pants', color: 0x14172a },
    { piece: 'jacket', color: 0x171b28, collar: 'high', trim: 0x93a6c8, hem: 0.43 },
...
export const GOJO_SHINJUKU = {
  ...
  outfit: [{ piece: 'pants', color: 0xd8d4c8, grow: 1.16, wide: 1.1 }, { piece: 'shirt', color: 0x14151b, sleeves: 1 }, { piece: 'belt', color: 0x111116 }],
...
export const YUJI_SHINJUKU = { ...YUJI, outfit: [{ piece: 'pants', color: 0x15172a }, { piece: 'shirt', color: 0x1a1d30, sleeves: 0.6 }, { piece: 'wraps', color: 0xe8e2d2 }], features: [{ kind: 'scar', at: [[-0.3, 0.1, 0.9], 0.03, 0.3, [0, -10, 15]], color: 0xb87070 }] };
export const YUJI_MODULO = { ...YUJI, hair: { style: 'spikesUp', color: 0xf0a0b8, length: 0.7, count: 14 }, features: [{ kind: 'sukunaMarks', color: 0x2a1418, eye: 0xd03040 }, { kind: 'bodyLines' }], outfit: [{ piece: 'pants', color: 0x15172a }, { piece: 'tank', color: 0x1a1d30 }], palette: { rim: 0xff7070, hairRim: 0xffd0da, outline: 0x120a10, accent: 0xff2f45, energy: 0xff3f4f } };
...
export const MEGUMI = {
  ...
  outfit: [
    { piece: 'pants', color: 0x14172a },
    { piece: 'gakuran', color: 0x161a2c, buttons: 0, trim: 0x2a2f4c, hem: 0.44 }
  ],
...
export const NOBARA = {
  ...
  outfit: [
    { piece: 'skirt', color: 0x15172a, hem: 0.34 },
    { piece: 'jacket', color: 0x171b2e, collar: 'high', trim: 0x2a2f4c, hem: 0.46 }
  ],
...
export const NANAMI = {
  ...
  outfit: [
    ...
    { piece: 'jacket', color: 0x22242e, collar: 'open', placket: false, hem: 0.42, sleeves: 1 },
