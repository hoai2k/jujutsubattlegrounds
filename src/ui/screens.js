...
export class Legend {
  constructor(root) {
    ...
    this.el.innerHTML = `
      ...
      <div><b>LB</b> dash — stamina <span style="color:#8b98bc">(Shift / RCtrl)</span>. From a STANDING stick, a direction and LB together is a DODGE: it opens with a burst that takes you clear of an attack, for a chunk of stamina up front. Tapping LB while already moving is just a sprint</div>
